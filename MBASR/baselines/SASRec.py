...
if __name__ == '__main__':
    ...
    save_dir = 'Tmall/model/sasrec/emb_{}_heads_{}_blocks_{}_dropout_{}_seed_{}_l2_{}_{}'.format(
    ...
    with tf.Session() as sess:
        ...
        for i in range(args.epoch):
            ...
            for j in range(num_batches):
                ...
                item_seq = [row[-7::-7][::-1]+[item_num]*43 for row in item_seq]
    ...
    # with tf.Session() as sess :
    #     saver.restore(sess, '/home/temp_user/xiaoj/SHOCCF-baselines/UB/model/sasrec/emb_64_heads_1_blocks_2_dropout_0.5_seed_0_l2_0.0_20231229_192227/epoch_73_hit@5_0.0736_ndcg@5_0.0474_hit@10_0.1076_ndcg@10_0.0583_hit@20_0.1474_ndcg@20_0.0684/sasrec.ckpt')
    #     hit5, ndcg5, hit10, ndcg10, hit20, ndcg20 = evaluate_origin(sess, SASRec, data_directory, topk,
    #                                                                 have_dropout=True, have_user_emb=False,
    #                                                                 is_test=True)
    #     hit5, ndcg5, hit10, ndcg10, hit20, ndcg20 = evaluate_origin(sess, SASRec, data_directory, topk,
